...
public class Parameters {  
    ...
    @Parameter(names = {"-extra"}, description = "Generate hash meta data (source file URI, file size, SHA-256 hash of file", converter = BooleanConverter.class, validateWith = Dcm2RdfValidator.class, order = 9)
   ...
   @Parameter(names = {"-naming"}, description = "Subject method (SOPInstanceUID, SHA256)", required = true, validateWith = Dcm2RdfValidator.class, order = 10)
    ...
    @Parameter(names = {"-level"}, converter = LogLevelConverter.class, description = "Sets logging level (OFF, ALL, WARNING, SEVERE)", order = 12)
